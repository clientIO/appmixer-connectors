...
module.exports = {
    ...
    receive: async function(context) {
        ...
        // For example: 1701980838697_openai_createSpeech
        const filename = `${Date.now()}_${context.componentType.split('.')[1]}_${context.componentType.split('.')[3]}`;
        const file = await context.saveFileStream(filename, data); // data is a buffer
    ...
    httpRequest: async function(context) {
        ...
        let url = lib.getBaseUrl(context) + '/audio/speech';
