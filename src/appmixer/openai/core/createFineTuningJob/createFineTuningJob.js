...
module.exports = {
    ...
    httpRequest: async function(context) {
        ...
        const inputMapping = {
            ...
            'hyperparameters.batch_size': input['hyperparameters|batch_size'],
            'hyperparameters.learning_rate_multiplier': input['hyperparameters|learning_rate_multiplier'],
            'hyperparameters.n_epochs': input['hyperparameters|n_epochs']
        };
        let requestBody = {};
