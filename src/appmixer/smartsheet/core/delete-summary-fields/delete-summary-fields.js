...
module.exports = {
    ...
    httpRequest: async function(context) {
        ...
        let url = lib.getBaseUrl(context) + `/sheets/${input['sheetId']}/summary/fields`;

        const headers = {};
        const query = new URLSearchParams;

        const queryParameters = { 'ids': input['ids'],
            'ignoreSummaryFieldsNotFound': input['ignoreSummaryFieldsNotFound'] };
