...
module.exports = {
    ...
    httpRequest: async function(context) {
        ...
        let url = lib.getBaseUrl(context) + `/workspaces/${input['workspaceId']}/sheets/import`;
        ...
        const queryParameters = { 'sheetName': input['sheetName'],
            'headerRowIndex': input['headerRowIndex'],
            'primaryColumnIndex': input['primaryColumnIndex'] };
