...
module.exports = {
    ...
    httpRequest: async function(context) {
        ...
        const inputMapping = {
            'name': input['name'],
            'projectSettings.lengthOfDay': input['projectSettings|lengthOfDay'],
            'projectSettings.nonWorkingDays': input['projectSettings|nonWorkingDays'],
            'projectSettings.workingDays': input['projectSettings|workingDays'],
            'userSettings.criticalPathEnabled': input['userSettings|criticalPathEnabled'],
            'userSettings.displaySummaryTasks': input['userSettings|displaySummaryTasks']
        };
        let requestBody = {};
