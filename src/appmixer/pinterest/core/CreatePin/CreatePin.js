...
module.exports = {
    async receive(context) {
        const { boardId, boardSectionId, title, description, altText, dominantColor, link, note, sourceType, imageUrl, imageUrlArray, imageBase64ContentType, imageBase64Data, imageBase64Array, coverImageUrl, mediaId } = context.messages.in.content;
