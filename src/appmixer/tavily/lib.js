...
const DEFAULT_PREFIX = 'tavily-objects-export';
...
module.exports = {
     ...
     * Tavily API base and refuse anything that would send the account's API key
     * somewhere else.
     *
     ...
     * @param {string} url relative path (e.g. '/search') or absolute Tavily URL
     * @returns {string} absolute URL on the Tavily API host
     */
    ...
    /**
     * Thin wrapper around context.httpRequest that applies the Tavily bearer auth
     * header and returns the parsed response body. context.httpRequest throws on
     ...
     * @param {string} [args.method] HTTP method (default POST — most Tavily endpoints are POST)
