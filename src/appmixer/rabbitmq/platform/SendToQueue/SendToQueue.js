...
module.exports = {
    ...
    async receive(context) {
        ...
        if (!channelId) {
            ...
            // This can occur if another component sent a message to our SendToQueue before our start() method finished.
        ...
        await context.callAppmixer({
            endPoint: `/plugins/appmixer/rabbitmq/producers/${channelId}/sendToQueue`,
            method: 'POST',
            body: payload
        });
