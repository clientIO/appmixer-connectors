...
const updateEvent = Promise.promisify(calendar.events.update, { context: calendar.events });
...
/**
 * Component for event update on google calendar.
 * @extends {Component}
 */
module.exports = {
    ...
    receive(context) {
        ...
        const { calendarId, eventId, start, end } = context.messages.in.content;
        if (!calendarId) {
