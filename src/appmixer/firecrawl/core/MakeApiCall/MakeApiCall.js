...
module.exports = {
    ...
    async receive(context) {
        ...
        // The Firecrawl API key is attached to every request below, so the
        // target has to be pinned to the Firecrawl API. Without this an
        // absolute URL pointing at a third-party host would leak the account's
        // secret to that host.
