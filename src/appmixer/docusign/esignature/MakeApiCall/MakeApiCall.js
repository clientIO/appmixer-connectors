...
module.exports = {
    async receive(context) {
        ...
        const account = context.profileInfo && context.profileInfo.accounts && context.profileInfo.accounts[0];
        if (!account) {
            throw new context.CancelError('Unable to determine DocuSign account base URI.');
        }
